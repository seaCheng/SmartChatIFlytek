...
namespace SparkChain
{
    typedef enum {
        ...
        SPARKCHAIN_ERR_SPARK = SPARKCHAIN_ERR_AUTH + 900,  
        SPARKCHAIN_ERR_DEVICE_AUTH = SPARKCHAIN_ERR_AUTH + 1000,  

        SPARKCHAIN_ERR_AUTH_LICENSE_NOT_FOUND = SPARKCHAIN_ERR_AUTH + 0,  // 18000 
        SPARKCHAIN_ERR_AUTH_LICENSE_FILE_INVALID = SPARKCHAIN_ERR_AUTH + 1,  // 18001 
        SPARKCHAIN_ERR_AUTH_LICENSE_PARSE_FAILED = SPARKCHAIN_ERR_AUTH + 2,  // 18002 
        SPARKCHAIN_ERR_AUTH_PAYLOAD_DEFECT = SPARKCHAIN_ERR_AUTH + 3,  // 18003 
        SPARKCHAIN_ERR_AUTH_SIGN_DEFECT = SPARKCHAIN_ERR_AUTH + 4,  // 18004 
        SPARKCHAIN_ERR_AUTH_EXPIRED = SPARKCHAIN_ERR_AUTH + 5,  // 18005 
